...
export const DashboardIcon: React.FC<IconProps> = ({ className = 'w-5 h-5', size = 20 }) => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="M3 12l2-3m0 0l7-4 7 4M5 9v10a1 1 0 001 1h12a1 1 0 001-1V9m-9 11v-5m0 0V9m9 5v-5m0 5a1 1 0 11-2 0m2 0a1 1 0 11-2 0m-9 0a1 1 0 11-2 0m2 0a1 1 0 11-2 0"
    />
  </svg>
);

export const LinksIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
